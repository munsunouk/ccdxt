...
from selenium.common.exceptions import TimeoutException, NoSuchWindowException, ElementClickInterceptedException,ElementNotInteractableException
...
class Defilima(Exchange):
    ...
    def set_crawling(self) :
        ...
        chrome_options.add_argument(
            ...
            Chrome/97.0.4692.71 Safari/537.36") # for not being catched as bot
    ...
    def retry(method):
        ...
        def retry_method(self, *args):
            for i in range(self.retries):
                ...
                except (TimeoutException,NoSuchWindowException,ElementClickInterceptedException, ElementNotInteractableException):
                    if i == self.retries - 1:
                        raise
    ...
    def connect_wallet(self):
        ...
        connect_wallet1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//button[contains(@class,"main-access-btn")]'))).send_keys(Keys.ENTER)

        connect_kaikas1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[contains(@id,"modals-container")]//li[contains(@class,"select-wallet-modal__service__row pointer")]'))).click()
    ...
    def create_wallet(self) :
        ...
        create_password = self.wait.until(EC.presence_of_element_located((By.XPATH,'//input[@id="create-password"]'))).send_keys(self.password)

        confirm_password = self.wait.until(EC.presence_of_element_located((By.XPATH,'//input[@id="confirm-password"]'))).send_keys(self.password)

        click_button1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="btn-container"]/button[1]'))).send_keys(Keys.ENTER)
    ...
    def restore_wallet(self) :
        ...
        '''
        back_button = self.wait.until(EC.presence_of_element_located((By.XPATH,'//ul[@class="tabs__list"]/li[2]'))).click()

        # input_seed
        for i in range(1,13) :
            
            elem = self.wait.until(EC.presence_of_element_located((By.XPATH,f'//div[@class="input-grid"]/div[{i}]//input[1]')))
            elem.send_keys(self.seed[i-1])

        button1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//button[@class="button btn-primary first-time-flow__button"]'))).send_keys(Keys.ENTER)

        button2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="security-guide"]//button[1]')))
        
        self.driver.execute_script("arguments[0].click();", button2)

        click_check1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="checkbox-icon"]'))).click()

        button3 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//button[@class="button btn-primary btn--large page-container__footer-button"]'))).send_keys(Keys.ENTER)
    ...
    def reconnect_wallet(self) :
        ...
        connect_wallet2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//button[contains(@class,"main-access-btn")]'))).send_keys(Keys.ENTER)

        connect_kaikas2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[contains(@id,"modals-container")]//li[contains(@class,"select-wallet-modal__service__row pointer")]'))).click()
    ...
    def get_walletRiskinfo(self) :
        ...
        click_check2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/div/section[4]/div[1]/div[1]'))).click()

        click_check1_button = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div[2]/div/div[2]/div/section/article/button'))).send_keys(Keys.ENTER)

        click_check3 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/div/section[4]/div[2]/div[1]'))).click()
        
        click_check4 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="about-risk-modal__disable__check"]'))).click()

        click_button2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/div/section[6]/button'))).click()
    ...
    def get_slippage(self) :
        ...
        '''
        click_slippage = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="pointer"]')))

        self.driver.execute_script("arguments[0].click();", click_slippage)

        click_slippage_input = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/section/article[4]//input[1]')))
    ...
    def confirm_slippage(self) :
        ...
        click_button = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="base-modal HandleSlippageModal"]//article[@class="gen-modal-submit-wrap"]/button'))).send_keys(Keys.ENTER)
        
        confirm_button = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="base-modal CommonWarningModal"]//button[@class="common-warning-modal__submit"]'))).send_keys(Keys.ENTER)
    ...
    def click_asset(self) :
        ...
        self.wait.until(EC.presence_of_element_located((By.XPATH,'//nav[contains(@class,"main-header__nav")]//li[1]'))).click()
    ...
    def click_swap(self) :
        ...
        self.wait.until(EC.presence_of_element_located((By.XPATH,'//nav[contains(@class,"main-header__nav")]//li[2]/span'))).click()
    ...
    def get_riskWarning(self) :
        ...
        #3-1 안전 유의사항 존재할시 클릭
        click_check = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[contains(@class,"base-modal SelectUnsafeTokenModal")]//div[contains(@class,"confirm-on-modal-option__check")]'))).click()

        click_button = self.wait.until(EC.presence_of_element_located((By.XPATH,'//article[contains(@class,"gen-modal-submit-wrap")]'))).click()
    ...
    def get_token_info(self,symbol) :
        ...
        click_from_icon = self.wait.until(EC.presence_of_element_located((By.XPATH,f'//section[contains(@class,"exchange-swap-page")]/article[{symbol}]//div[contains(@class,"ic-wrap")]')))
    ...
    def get_token_symbol(self,token) :
        ...
        click_from_input2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[contains(@id,"modals-container")]//input[1]')))

        click_from_input2.send_keys(token)

        click_token2 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//section[contains(@class,"ps")]//div[1]')))
    ...
    def get_swapSize(self,size,flip):
        ...
        if  flip == True :
            ...
            click_from_swapinput1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'(//article[contains(@class,"exchange-value-input")])[2]//input[@class="md-input"]')))
            
        else :
            
            click_from_swapinput1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'//article[contains(@class,"exchange-value-input")]//input[@class="md-input"]')))
    ...
    def get_swapSize_click(self):
        ...
        try :
            ...
            click_exchange = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="exchange-page"]/div/section[1]/div[2]/article[2]'))).click()
            
        except :
            
            if len(self.driver.window_handles) == 2 :

                change_window_kaikas_ins = self.driver.switch_to.window(self.driver.window_handles[-1])
    ...
    def get_swapInfo(self) :
        ...
        self.transaction_info = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/div/div[3]'))).get_attribute("textContent")
    ...
    def get_swapInfo_click(self) :
        ...
        click_swap_info = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="modals-container"]/div/div/div[2]/div/div/div[4]/button'))).send_keys(Keys.ENTER)
    ...
    def get_swapWallet(self) :
        ...
        gasfee_info = self.wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="fee-detail-row__discountedFee"]'))).text
    ...
    def get_swapWallet_click(self) :
        ...
        try :
            ...
            click_kaikas_swap = self.wait.until(EC.presence_of_element_located((By.XPATH,'//button[@class="button btn-primary btn--large page-container__footer-button"]'))).send_keys(Keys.ENTER)
            ...
            try :
                ...
                click_kaikas_swap = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="app-content"]/div/div[2]/div/div[3]/header/button[2]')))
                ...
                try :
                    ...
                    click_kaikas_swap = self.wait.until(EC.presence_of_element_located((By.XPATH,'//*[@id="app-content"]/div/div[2]/div/div[3]/header/button[2]'))).click()
    ...
    def get_quoteData(self,size) :
        ...
        click_from_swapinput1 = self.wait.until(EC.presence_of_element_located((By.XPATH,'(//section[contains(@class, "exchange-swap-page")]//article[contains(@class,"exchange-value-input")][1])//div[@class="md-input-wrap"]/input[1]')))
        ...
        token_info = self.wait.until(EC.presence_of_element_located((By.XPATH,'//article[contains(@class,"exchange-rate-and-pool-info")]'))).get_attribute("textContent")
        ...
        try : 
            result["Fee"].append(f"{result_klay[result_klay.index('Fee')+1]+''.join(dict.fromkeys(result_klay[result_klay.index('Fee')+2]))}")
    ...
    def get_balance(self):
        ...
        tokenA_balance = self.wait.until(EC.presence_of_element_located((By.XPATH,'(//span[@class = "pointer"])[2]'))).get_attribute("textContent")

        tokenB_balance = self.wait.until(EC.presence_of_element_located((By.XPATH,'(//span[@class="pointer"])[3]'))).get_attribute("textContent")
    ...
    def flip_token(self) :
        ...
        click_flip = self.wait.until(EC.presence_of_element_located((By.XPATH,'//article[@class="exchange-center-icon"]//img')))
