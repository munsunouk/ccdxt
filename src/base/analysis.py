...
def analyse_trade_by_hash(self, tx_hash: str) -> Union[TradeSuccess, TradeFail]:
    ...
    return analyse_trade_by_receipt(self, tx, tx_hash, tx_receipt)


def analyse_trade_by_receipt(self, tx: dict, tx_hash: str, tx_receipt: dict) -> Union[TradeSuccess, TradeFail]:
